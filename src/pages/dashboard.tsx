...
import { useRoqPlatformUserProfiles, useTicketCount, useMovieCount, useShowTimeCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const showTimeStat = useShowTimeCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Show Times',
      result: showTimeStat?.data,
      isLoading: showTimeStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
