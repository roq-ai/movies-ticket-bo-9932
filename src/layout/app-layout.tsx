...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Movies', path: '/movies', entity: 'movie', service: AccessServiceEnum.PROJECT, icon: FiVideo },
    { name: 'Show Times', path: '/show-times', entity: 'show_time', service: AccessServiceEnum.PROJECT, icon: FiClock },
    {
      name: 'Team Members',
      path: '/team-members',
      entity: 'team_member',
