...
export function useShowTimeFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useShowTimeFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.show_time.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useShowTimeCount<T extends Prisma.show_timeCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.show_timeCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useShowTimeCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.show_time.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useShowTimeFindManyWithCount<
  T extends Prisma.show_timeFindManyArgs,
  R extends { data: GetFindResult<Prisma.$show_timePayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.show_timeFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useShowTimeFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.show_time.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useShowTimeFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useShowTimeFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.show_time.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
